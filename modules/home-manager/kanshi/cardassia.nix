...
in {
  profiles = {
    ...
    # Home: laptop on the left, Dell U2724DE (video over DP, USB-C for power)
    # on the right at its max 120 Hz. Bottom edges aligned: eDP is 1600 tall
    # vs the Dell's 1440. eDP runs 90 Hz (its only modes are 60/90).
    home = {
      outputs = [
        {
